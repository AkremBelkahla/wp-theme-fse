 ...
 */
const iconOptions = [
    { label: __( 'Étoile', 'minimalfse' ), value: 'star-filled' },
    { label: __( 'Cœur', 'minimalfse' ), value: 'heart' },
    { label: __( 'Ampoule', 'minimalfse' ), value: 'lightbulb' },
    { label: __( 'Éclair', 'minimalfse' ), value: 'bolt' },
    { label: __( 'Bouclier', 'minimalfse' ), value: 'shield' },
    { label: __( 'Graphique', 'minimalfse' ), value: 'chart-bar' },
    { label: __( 'Engrenage', 'minimalfse' ), value: 'admin-generic' },
    { label: __( 'Ordinateur', 'minimalfse' ), value: 'desktop' },
    { label: __( 'Mobile', 'minimalfse' ), value: 'smartphone' },
    { label: __( 'Pinceau', 'minimalfse' ), value: 'admin-customizer' },
];
...
export default function Edit({ attributes, setAttributes }) {
    ...
    const blockProps = useBlockProps({
        className: `feature-box align-${alignment}`,
    });

    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Paramètres de l\'icône', 'minimalfse')}>
                    <SelectControl
                        label={__('Icône', 'minimalfse')}
                        value={icon}
                        options={iconOptions}
                        onChange={(value) => setAttributes({ icon: value })}
                    />
                    <RangeControl
                        label={__('Taille de l\'icône', 'minimalfse')}
                        value={iconSize}
                ...
                <PanelColorSettings
                    title={__('Couleurs', 'minimalfse')}
                    colorSettings={[
                        {
                            value: iconColor,
                            onChange: (value) => setAttributes({ iconColor: value }),
                            label: __('Couleur de l\'icône', 'minimalfse'),
                        },
                    ]}
                />
                <PanelBody title={__('Paramètres du lien', 'minimalfse')}>
                    <TextControl
                        label={__('URL du lien', 'minimalfse')}
                        value={linkUrl}
            ...
            <div {...blockProps}>
                <div className="feature-box-icon" dangerouslySetInnerHTML={getIconSvg(icon, iconColor, iconSize)} />
                <RichText
                    tagName="h3"
                    className="feature-box-title"
                    value={title}
                    onChange={(value) => setAttributes({ title: value })}
                    placeholder={__('Titre de la fonctionnalité...', 'minimalfse')}
                />
                <RichText
                    tagName="p"
                    ...
                    placeholder={__('Description de la fonctionnalité...', 'minimalfse')}
                />
                <RichText
                    tagName="a"
                    ...
                    placeholder={__('Texte du lien...', 'minimalfse')}
                />
            </div>
        </>
    );
